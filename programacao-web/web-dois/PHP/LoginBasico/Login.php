...
<head>
  ...
  <style>
    ...
    .box{background:#fff; padding:20px; border-radius:6px; max-width:420px; margin:auto; box-shadow:0 2px 8px rgba(0,0,0,0.08);}
    ...
    .msg{color:#c00; margin-top:12px;}
    .note{font-size:0.9rem; color:#666; margin-top:14px;}
  </style>
</head>
<body>
  <div class="box">
    ...
    <p class="note">Usuários de teste: <strong>alice</strong> / senha <strong>senha1</strong> — <strong>bob</strong> / senha <strong>senha2</strong></p>
  </div>
</body>
</html>
